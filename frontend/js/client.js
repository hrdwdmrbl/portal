...
const roomId = "brasserie-de-s&m";
const namesOfBigCats = [
    "Lion",
    "Tiger",
    "Jaguar",
    "Leopard",
...
// Choose a random cat name
const peerName = namesOfBigCats[Math.floor(Math.random() * namesOfBigCats.length)];
...
const tooltips = [
    ...
    { element: ringBtn, text: 'Ring', position: 'top' },
